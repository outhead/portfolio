...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription:
      "Два года в Газпром Нефти, Head of Design. 10 дизайнеров в прямом подчинении, ~80 в компании через ЦК продуктового дизайна. С со-руководителем Светланой Любавской перевели центр компетенций со 2-го на 3-й уровень зрелости. За год — 57 проектов, 27+ выступлений на Стачке, Дизайн-Выходных и ПромТехДизайне. Главное — разморозил ЕСО, флагман на 50 000 пользователей и 60+ организаций ГПН: две предыдущие команды дизайна не смогли договориться с департаментами, мы договорились. CX Awards 2024.",
    tags: [
      "Enterprise",
      "B2B",
      "Design System",

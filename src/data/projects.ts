...
export const projects: Project[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        result:
          "Точечные истории, показательные по характеру эффекта: после редизайна каталога тарифов конверсия в подключение выросла заметно, нагрузка на поддержку — упала; смену тарифа на конвергент сократили с часов до минуты; Quick Complaint раскатили на десятки регионов и сократили время ответа более чем вдвое; конверсия на главной для неабонентов в телеком и MNP выросла кратно. На семейной группе вместе с командой запустили МТС.ГеоПоиск — публичное партнёрство с ЛизаАлерт (2 июня 2025). Накопления отдали бесшовно: всё подтягивается из госуслуг, минимум на счёт — 100 ₽, доходность по цифровым облигациям МТС.",
        callouts: [
      ...
      },
      {
        ...
        content:
          "Не всё взлетело — год был непростой, и кейс был бы нечестным без этой части. Часть направлений сворачивалась — я не вёл их сам, но решал, куда переводить дизайнеров, чтобы людей сохранить внутри функции. На Близких Людях случился конфликт между продактом и дизайнером — взял задачу под себя; рисовали со Светой и одним внешним дизайнером, отдельно от основной команды. Бюджет на дополнительных арт-директоров мне не открыли — это значило, что часть продуктов я арт-директил сам, в ущерб времени на стратегические задачи; если бы перезапускал — раньше пришёл бы к CPO и торговался жёстче на этапе захода. UX-ресерч хотели вырастить как отдельную функцию — за год команда сократилась через увольнения, новых не нанимали. Эту тему закрыть не успел.",
      },
    ],
    links: [

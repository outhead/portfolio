...
export const projects: Project[] = [
  {
    ...
    year: 2024,
    description:
      "Руковожу дизайном B2C-экосистемы (8 команд, 40+ дизайнеров) и AI-дивизиона МТС. Запустил МТС Маркет, Legal Copilot, IAM Admin. Сократил бюджет на коммуникационные задачи на 40%, TTM — на 60%.",
    longDescription:
  ...
  },
  {
    ...
    year: 2022,
    description:
      "76 команд, 42 дизайн-лида, 100+ дизайнеров. Развивал open-source дизайн-систему Consta (150 Figma WAU, 10K+ NPM-скачиваний). Победитель CX Awards 2024 за ЕСО — единое сервисное окно.",
    longDescription:
  ...
  },
  {
    ...
    year: 2021,
    description:
      "Заложил основы дизайн-комьюнити в Ozon. Вырастил Telegram-канал HR-бренда с 0 до 17 000 подписчиков. Найм +40%, текучка −60%. Внедрил design-review и UX-исследования.",
    longDescription:
  ...
  },
  {
    ...
    year: 2018,
    description:
      "Формировал дизайн-стратегию МТС. 16 команд, 12 дизайн-лидов, 60+ дизайнеров. МТС Cashback (8.8М пользователей, ×10 транзакций), Premium (2.9М, ×2 подписок), Строки (1.5М, ×2.5 рост).",
    longDescription:
  ...
  },
  {
    ...
    year: 2024,
    description:
      "AI-ассистент для юристов. Чат-интерфейс с RAG-поиском по документам, генерация заключений, анализ договоров. Время поиска информации сократилось в 5 раз.",
    longDescription:
  ...
  },
  {
    ...
    year: 2025,
    description:
      "Серия экспериментов с Three.js и шейдерами: стеклянные 3D-фигуры с внутренней геометрической сеткой, aurora ribbons, морфинг между формами.",
    longDescription:
  ...
  },
  {
    ...
    year: 2025,
    description:
      "Telegram-бот, который превращает ссылки, голосовые и текст в посты для авторского канала про AI. Python + aiogram + Claude API.",
    longDescription:

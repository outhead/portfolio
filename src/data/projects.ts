...
export const projects: Project[] = [
  {
    ...
    year: 2024,
    description:
      "3 продукта в проде, time-to-market −60%, коммуникационный бюджет −40%. Управляю дизайном B2C-экосистемы (8 команд, 40+ дизайнеров) и строю AI-дивизион МТС с нуля.",
    longDescription:
  ...
  },
  {
    ...
    year: 2022,
    description:
      "CX Awards 2024, навигация < 30 сек, CSI 75%. Управлял 100+ дизайнерами в 76 командах. Запустил open-source дизайн-систему Consta: 150 Figma WAU, 10K+ NPM.",
    longDescription:
  ...
  },
  {
    ...
    year: 2018,
    description:
      "8.8М пользователей Cashback, ×10 транзакций. Вырос от дизайнера до руководителя направления: 16 команд, 60+ человек.",
    longDescription:

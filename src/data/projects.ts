...
export const projects: Project[] = [
  {
    ...
    year: 2024,
    description:
      "3 продукта в проде, скорость запуска −60%, коммуникационный бюджет −40%. Управляю дизайном B2C-экосистемы (8 команд, 40+ дизайнеров) и строю AI-дивизион МТС с нуля.",
    longDescription:
  ...
  },
  {
    ...
    year: 2022,
    description:
      "CX Awards 2024, навигация по сервисам < 30 сек, CSI 75%. Управлял 100+ дизайнерами и 76 командами. Вырастил open-source дизайн-систему Consta до 150 Figma WAU и 10K+ NPM-скачиваний.",
    longDescription:
  ...
  },
  {
    ...
    year: 2021,
    description:
      "Найм дизайнеров +40%, текучка −60%, HR-канал с 0 до 17 000 подписчиков. Заложил основы дизайн-комьюнити: design-review, UX-исследования, регулярные дизайн-критики.",
    longDescription:
  ...
  },
  {
    ...
    year: 2018,
    description:
      "8.8М пользователей Cashback, ×10 транзакций. Premium 2.9М (+×2), Строки 1.5М (+×2.5). Вырос от дизайнера до руководителя направления: 16 команд, 60+ дизайнеров, дизайн-стратегия экосистемы.",
    longDescription:

...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: 2022,
    description:
      "Собрал дизайн-функцию из 80 разрозненных дизайнеров и разморозил ЕСО — флагманский внутренний портал на 50 000 пользователей, который стоял в макетах два года. CX Awards 2024. Развивал open-source дизайн-систему Consta — на ней построены 180+ цифровых продуктов компании.",
    longDescription:
    ...
    sections: [
      ...
      {
        title: "Витринные кейсы — три из 36 in-house проектов",
        context:
          "В год команда вела 36 продуктовых проектов внутри компании. Три из них показывают разные стороны работы: командный формат, сервисный дизайн и стандартизация.",
        result:

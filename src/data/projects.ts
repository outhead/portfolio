    ...
    sections: [
      {
        ...
        approach:
          "С со-руководителем Светланой Любавской — пять направлений одновременно: карта людей через асессмент, матричное подчинение (10 в прямом + дизайн-директора департаментов в функциональном), общие ритуалы (дейли, ревью, синки, карта компетенций), дизайн как сервис (бесплатные консультации, ревью), системные точки входа (Confluence, Jira Sourcing).",
        result:
      ...
      },
      {
        ...
        approach:
          "Три канала параллельно: внешние выступления, партнёрства с обр. организациями, внутреннее комьюнити.",
        result:
          "27+ выступлений за год на 15+ мероприятиях (Стачка ~20K, Дизайн-Выходные ~40K, ПромТехДизайн 240K онлайн). Партнёрства: Bang Bang Education, Young Design (совместная номинация «Интерфейс» — модуль для геомоделирования на Consta), Институт Штиглица. Внутреннее: 6 митапов в год, открытые инфо-сессии. Виральная история с пропусками: идея совпала у меня и у Вики Кудрявцевой из команды — объединились, довели до конца. 1.5 года, 300+ человек прошло. После моего ухода Вика навайбкодила генератор бейджей через ChatGPT — open-source, сервис живёт.",
        helped:
      ...
      {
        title: "Витринные кейсы — что именно делали 36 in-house проектов",
        result:

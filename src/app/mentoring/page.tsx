      ...
      <section className="relative px-5 md:px-[6%] lg:px-[10%] xl:px-[14%] py-20 md:py-32 border-t border-white/[0.04] bg-black/75">
        <div className="max-w-5xl">
          ...
          <p className="animate-fade-in-up animation-delay-200 text-base md:text-lg text-white/60 leading-relaxed max-w-2xl">
            ...
            8+ лет опыта управления в крупных компаниях — делюсь конкретными инструментами,
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                title: "Мастерклассы",
                description:
                  "Практические воркшопы: как решать задачи с помощью нейросетей, AI-инструменты для дизайна, как управлять собой и командой как лид.",
                duration: "2–4 часа",
              },
            ].map((format, i) => (

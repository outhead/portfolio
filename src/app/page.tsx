          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5">
            {[
              ...
              },
              {
                ...
                body:
                  "Чтобы найти новое — надо копать вглубь, а без огня к делу это не получается. Я горю учиться, учить и делиться, поэтому везде собираю комьюнити заинтересованных. Новые подходы тащим вместе.",
                wide: true,
              },
            ].map((p) => (
              <motion.div

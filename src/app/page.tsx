          ...
          <div className="grid md:grid-cols-3 gap-3 md:gap-4">
            {[
              ...
              },
              {
                ...
                index: "02",
                label: "ПРОДУКТ",
                title: "B2C, B2E и EdTech — на метрики",
                Icon: Sparkles,
                accent: "#C9A66B",
                animation: "spiral" as PulseVariant,
                animationReverse: true,
                body:
                  "Работаю на число. Discovery, гипотезы, CJM, A/B, research внутри процесса. Умею считать дизайн и доказывать его ценность продакт-менеджеру и C-левелу — в B2C-экосистемах, B2E-инструментах и EdTech.",
                items: [
                  "B2C-экосистемы",
              ...
              },
              {
                ...
                body:
                  "Остаюсь в макетах и в IDE. React/TS, WebGL, AI-инструменты и агенты. Понимаю, что реально сделать руками и сколько это стоит в человеко-часах. Знаю, когда применять AI, а когда — позвать эксперта под задачу.",
                items: [
            ...
            {[
              {
                ...
                body:
                  "Если после релиза метрика не двинулась — работа не сделана. Discovery, гипотезы, A/B и обратная связь с продуктом — обязательные этапы, не опциональные.",
                wide: true,
              },
              {
                n: "02",
                ...
                body:
                  "Лид, который не открывает свой продукт, быстро теряет контакт с реальностью — а за ним и команда. Все участники отвечают за ошибки в коде: промолчал — значит согласился.",
              },
              {
                n: "03",
                title: "Команда сильнее героя.",
                body:
                  "10 сильных людей без меня делают больше, чем я один на износе. Нанимаю на рост, даю зоны, поддерживаю мотивацию и даю инструменты для развития.",
              },
              {
                n: "04",
                title: "AI — не фича, это новая ось.",
                body:
                  "AI меняет не «один экран», а всю ось: как пользователь формулирует намерение, как мы проектируем интерфейс, где теперь границы возможностей.",
                wide: true,
              },
            ].map((p) => (
              <motion.div

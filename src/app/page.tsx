        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5">
            {[
              ...
              {
                n: "04",
                title: "AI поменял не интерфейс, а постановку задачи",
                body:
                  "Пользователь больше не ищет кнопку, он формулирует намерение. Это другой уровень, и старые лекала про экраны на нём работают только наполовину. Я горю учиться, учить и делиться знаниями — поэтому в каждой компании собираю комьюнити заинтересованных: митапы, чаты, открытые уроки, гостевые посты. Команда растёт не от меня одного, она растёт от тех, кто сам горит и тащит вокруг себя. Моя работа — собрать таких людей в одно пространство и дать им импульс. Именно они находят новые подходы.",
                wide: true,
              },
            ].map((p) => (
              <motion.div
            ...
            <motion.div variants={fadeUp} className="flex flex-col">
              ...
              <div className="space-y-4 md:space-y-5 max-w-2xl">
                <p className="text-sm md:text-[15px] text-white/70 leading-relaxed">
                  Пришёл в дизайн из агентств и&nbsp;остался в&nbsp;нём по простой причине: мне нравится соединять несочетаемое, людей, цифры и&nbsp;ремесло. В какой-то момент это оказалось не побочным интересом, а рабочей профессией.
                </p>
                <p className="text-sm md:text-[15px] text-white/70 leading-relaxed">
                  Сейчас мне интересна связка «дизайн и&nbsp;AI». Преподаю это в&nbsp;ВШЭ, экспериментирую сам, пишу код. Иногда поделки получаются криво, но это часть процесса.
                </p>
                <p className="text-sm md:text-[15px] text-white/70 leading-relaxed">
                  Работаю от задачи, а&nbsp;не от процесса. Участвую глубоко: от стратегии до&nbsp;ревью макетов. По моим ощущениям, хороший лид должен уметь и&nbsp;собрать команду, и&nbsp;открыть редактор кода. Это не догма, скорее моя личная планка.
                </p>
              </div>

          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5">
            {[
              ...
              },
              {
                ...
                body:
                  "Пользователь больше не ищет кнопку, он формулирует намерение. Это другой уровень, и старые лекала про экраны на нём работают только наполовину. Я сам ещё разбираюсь, как переучиться, и команды учу так же.",
                wide: true,
              },
            ].map((p) => (
              <motion.div
